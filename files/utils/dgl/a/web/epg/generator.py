...
TV_SMS_CZ_IDS = "10,11,1324,8,33,683,206,1141,718,225,42,2,3,1333,73,65,805,1125,220,1122,1196,496,1162,708,1320,232,106,202,249,70,69,1169,15,549,207,1171,82,72,215,1018,1020,9,59,687,800,205,1038,75,221,985,51,127,30,53,736,831,228,1012,62,1198,833,191,19,20,26,195,190,1241,1245,57,999,704,804,1199,55,125,126,32,1149,1522,1309,1408,1502,15291,1512,1192,1324,15509,15508,1472,15322,15482,1023,15292,1513,717,1187,1149,4,132,707,15290,1338,15402,15441,15562,15568,15412,15476,15537"
T_MOBILE_TV_GO_IDS = ""
MAGIO_GO_IDS = "4557,4566,4042"
O2_TV_IDS = ""
MUJ_TV_PROGRAM_IDS = ""
SLEDOVANI_TV_CZ_IDS = ""
        ...
        try:
            ...
            if ftp_upload == 1:
                try:
                    ...
                    ftp.cwd(ftp_folder)
                    file = open(fn, "rb")
                    ftp.storbinary('STOR ' + "guide.xml", file)
                    file.close()
                    ftp.quit()
                except Exception as ex:
                    print("Chyba\n")
