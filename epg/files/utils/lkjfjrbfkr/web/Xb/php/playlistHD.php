...
$string = file_get_contents('http://jurooo.wz.cz/Xb/orangetv.playlistHD.m3u8');

##### Script na parsovanie - rozložím si pole na menšie celky, z ktorých budem vedieť čítať potrebné údaje, napr. url

$playlist02 = file_get_contents('http://jurooo.wz.cz/Xb/orangetv.playlistHD.m3u8');
preg_match_all('/(?<link>http\S+\.mpd)/', $playlist02, $matches);
